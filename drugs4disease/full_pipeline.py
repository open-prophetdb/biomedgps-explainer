    ...
    try:
        ...
        try:
            visualizer.generate_report(
                ...
                title=f"Drug Discovery Analysis Report - {disease_id}"
            )
        ...
        drug_names = drugs["drug_name"].tolist()[:50] if len(drugs) > 50 else drugs["drug_name"].tolist()
        disease_name = core.get_disease_name(disease_id, entity_file)
